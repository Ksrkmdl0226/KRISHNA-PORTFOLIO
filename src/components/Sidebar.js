            ...
            <div className="col-3 col-md-3 col-xl-2 px-sm-1 px-0 bg-dark slide-in-left navbar-md-expand">
                <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 text-white min-vh-100">
                    <Link to="/" className="d-flex align-items-center pb-1 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span className="" style={{fontWeight: '800', fontSize: '30px'}}>Portflio</span>
                    </Link>
                    <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <ul className="dropdown-menu shadow" aria-labelledby="dropdownUser1">
                            <li><a className="dropdown-item text-black" href="mailto:ksrkmdl@gmail.com"><MdEmail className='fs-5'/> Email</a></li>
                            <li> <hr className="dropdown-divider"/> </li>
                            <li><a className="dropdown-item text-black" href="https://www.linkedin.com/in/krishna-kurdekar-5aa1b5212/" target="/blank"><AiFillLinkedin className='fs-5'/> LinkedIn</a></li>
                            <li> <hr className="dropdown-divider"/> </li>
                            <li><a className="dropdown-item text-black" href="https://wa.me/7760294984" target="/blank"><AiOutlineWhatsApp className='fs-5'/> WhatsApp</a></li>
                            <li> <hr className="dropdown-divider"/> </li>
                            <li><a className="dropdown-item text-black" href="https://github.com/Ksrkmdl0226" target="/blank"><AiFillGithub className='fs-5'/> Github</a></li>
                            
                            <li> <hr className="dropdown-divider"/> </li>
                            <li> <a className="btn btn-outline-dark ms-3" href={require("../files/resume.pdf")} download="WebDeveloperResume">Download CV</a></li>
                        </ul>
